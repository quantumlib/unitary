...
def main():
    ...
    parser.add_argument(
        "--num_rows", help="The number of rows of the checkboard. INT", default=8
    )
    parser.add_argument(
        "--num_columns", help="The number of columns of the checkboard. INT", default=8
    )
    parser.add_argument(
        "--num_vertical_pieces",
    ...
    parser.add_argument(
        "--GUI", help="If GUI is enabled. True or False", default="False"
    )
    parser.add_argument(
        "--p1", help="Select agent for player 1 to use.", default=human_player()
    )
    parser.add_argument(
        "--p2", help="Select agent for player 2 to use.", default=human_player()
    )
