...
class ConnectivityHeuristicCircuitTransformer:
    ...
    def __init__(self, device: cirq.Device):
        ...
        self.device = device
        self.mapping = None
        self.starting_qubit = self.find_start_qubit(device.metadata.qubit_set)
...
@cirq.transformer
class DynamicLookAheadHeuristicCircuitTransformer:
    ...
    def __call__(
        ...
        *,
        ...
        updater = su.SwapUpdater(
            circuit, self.device.metadata.qubit_set, initial_mapping
        )
